...
<body class="font-sans antialiased">
    ...
    <div class="min-h-screen bg-gray-100 flex">
        ...
        <main class="flex-1 p-4 mt-20">
            ...
            <form method="POST" action="{{ route('cliente.update', $cliente->ci) }}">
                @csrf
                @method('PUT')
                @if ($errors->any())
            ...
            <div>
                <x-input-label for="ci"   
        :value="__('CI')" />
                <input type="number" name="ci" value="{{ old('ci', $cliente->ci) }}"> 
            ...
            <div>
                ...
                <input type="number" name="puntos" value="{{ old('puntos', $cliente->puntos) }}">
